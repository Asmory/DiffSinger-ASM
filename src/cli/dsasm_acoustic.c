...
static void print_features(uint32_t f){
    struct P{uint32_t b;const char*n;}p[]={{DSASM_FS2_FEAT_LANGUAGE,"language"},{DSASM_FS2_FEAT_BREATH,"breathiness"},{DSASM_FS2_FEAT_VOICING,"voicing"},{DSASM_FS2_FEAT_TENSION,"tension"},{DSASM_FS2_FEAT_KEY_SHIFT,"gender/key-shift"},{DSASM_FS2_FEAT_SPEED,"velocity/speed"},{DSASM_FS2_FEAT_SPEAKER,"speaker"},{DSASM_FS2_FEAT_STRETCH_TABLE,"stretch-table"},{DSASM_FS2_FEAT_LANGUAGE_MASK,"language-token-mask"},{DSASM_FS2_FEAT_NO_STRETCH,"no-stretch"},{DSASM_FS2_FEAT_FROZEN_SPEAKER,"frozen-speaker"},{DSASM_FS2_FEAT_EXACT_ROPE,"exact-rope"},{DSASM_FS2_FEAT_RAW_DURATION,"raw-duration"},{DSASM_FS2_FEAT_ADAPTIVE_LN,"adaptive-layernorm"}};
